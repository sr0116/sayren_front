                ...
                {!expanded && (
                    <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-white to-transparent flex items-end justify-center">
                        <button
                            ...
                            className="bg-[#ff0066] text-white font-semibold px-6 py-2 rounded-full mb-4 shadow hover:bg-[#e5005c] transition"
                        >
                            더보기 ↓
                        </button>
                    </div>
            ...
            {expanded && (
                <div className="flex justify-center mt-6">
                    <button
                        ...
                        className="text-[#ff0066] font-semibold border border-[#ff0066] px-6 py-2 rounded-full hover:bg-[#ff0066] hover:text-white transition"
                    >
                        접기 ↑
                    </button>
                </div>
