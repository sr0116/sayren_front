...
export default function CheckoutPage() {
  ...
  const months = selectedPlan?.month && selectedPlan.month > 0 ? selectedPlan.month : 36;
  ...
  if (!productInfo)
    return (
      <div className="text-center p-20 text-gray-500">상품 정보를 불러오는 중입니다...</div>
    );
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm mb-1">
                  카테고리: {productInfo.productCategory} | 모델명: {productInfo.modelName}
                </p>
                <p className="text-gray-600">
                  요금제: {planType === "PURCHASE" ? "구매" : `렌탈 (${selectedPlan?.month || 36}개월)`}
                </p>
              </div>
